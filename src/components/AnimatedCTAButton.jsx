        ...
        <a ref={buttonRef} href={link} className="relative w-[60px] h-[60px] cursor-pointer inline-block">
            <div className="cta-background absolute inset-0 w-[60px] h-[60px] bg-[#FA9D79] rounded-full flex items-center">
               <div className="cta-text-container absolute left-[30px] overflow-hidden">
                   <div className="cta-text pr-3 text-lg font-medium text-CTA-button-text whitespace-nowrap">
                        {text}
                   </div>
               </div>
            </div>
            <div className="cta-circle absolute top-0 left-0 w-[60px] h-[60px] bg-accent rounded-full flex items-center justify-center z-10">
                <svg className="w-6 h-6 text-background" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
