...
//                                 {/* ✅ FIX: Wrapped title in a div, moved ref here, and added MIB Impact heading */}
...
//                                             hAxis: { textStyle: { color: "#FFC7A8" }, gridlines: { color: "#fff" }, baselineColor: "#fff" },
//                                             vAxis: { textStyle: { color: "#FFC7A8" }, gridlines: { color: "transparent" }, baselineColor: "rgba(255, 199, 168, 0.2)" },
//                                             colors: ["#F47A36"],
