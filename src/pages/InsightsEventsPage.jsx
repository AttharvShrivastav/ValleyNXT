            ...
            <div className="w-[90%] md:w-[85%] max-w-7xl mx-auto flex-grow flex flex-col pb-24 mt-12">
                ...
                <section className="mb-24 w-full">
                    <h2 className="text-3xl md:text-4xl font-primary font-bold text-center mb-16">
                        In The <span className="font-serifa text-accent font-normal">News</span>
                    </h2>

                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                        {newsData.map(item => (
                            <div key={item.id} className="bg-container-bg border-2 border-accent/20 rounded-[2rem] p-6 flex flex-col hover:shadow-lg transition-shadow duration-300">
                                
                                {/* Image Placeholder (Responsive Checkerboard) */}
                                ...
                                {/* Title */}
                                <h3 className="text-lg md:text-xl font-primary font-bold leading-snug mb-4">
                                    {item.title}
                                </h3>
                                ...
                                {/* Figma-Matched "View Clipping" Button */}
                                <a 
                                    href={item.link} 
                                    target="_blank" 
                                    rel="noopener noreferrer" 
                                    className="text-accent font-primary font-bold text-xs uppercase tracking-wider flex items-center group mt-auto w-max"
                                >
                                    VIEW CLIPPING
                ...
                <section className="w-full">
                    <h2 className="text-3xl md:text-4xl font-primary font-bold text-center mb-12">
                        Glimpses of <br />
                        <span className="font-serifa text-accent font-normal">Our Ecosystem</span>
                    </h2>

                    {/* Figma-Matched Pill Tab Bar */}
                    ...
                    {/* CSS Masonry Grid for Event Images */}
