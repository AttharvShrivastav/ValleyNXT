...
const founders = [
  {
    ...
    image: DrMadhuImage,
    linkedin:
      "https://www.linkedin.com/in/dr-madhu-vasepalli-mds-43a24812/",
  },
  {
    id: 2,
...
const advisory = [
  {
    ...
    linkedin:
      "https://en.wikipedia.org/wiki/Rajnish_Kumar_%28banker%29",
  },
  {
    id: 11,
...
const investmentTeam = [
  ...
  },
  {
    ...
    linkedin:
      "https://www.linkedin.com/in/harshwardhan-saklecha/",
  },
  {
    id: 13,
    name: "Aditya Sharma",
  ...
  },
  {
    ...
    linkedin:
      "https://www.linkedin.com/in/shivangi-kashyap-937b271a0",
  },
];
...
const TeamCategorySection = ({ title, members }) => {
  return (
    <section className="w-full max-w-7xl mx-auto px-8 py-16">
      <h2 className="text-4xl md:text-5xl font-normal font-primary text-text-main text-center mb-12">
        {title}
      </h2>
